...
/// [buttonText] is the text displayed inside the button at the bottom of the
/// edit address page
///
/// [headerText] is the text displayed at the top of the edit address page and
...
class EditAddressWidget<T extends PickerItemModel> extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Material(
        child: InkWell(
          splashColor: context.editAddressTheme.editAddressWidgetSplashTransparent,
          highlightColor: context.editAddressTheme.editAddressWidgetHighlightTransparent,
